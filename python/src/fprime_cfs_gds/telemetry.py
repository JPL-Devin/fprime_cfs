"""fprime_cfs_gds.telemetry: cFS GroundSystem telemetry configuration generation
...
def generate_telemetry(dictionary: Dictionary, tlm_gui_dir: Path) -> int:
    ...
    with definition_path.open("w") as file_handle:
        file_handle.write(
            "# F Prime packetized telemetry definition generated by fprime-cfs-gds-config\n"
    ...
    with pages_path.open("w") as file_handle:
        file_handle.write(
            "# F Prime telemetry pages generated by fprime-cfs-gds-config\n"
